...
class RestrictUserCommandOptions {
    ...
    @Option(names = {"--message"}, defaultValue = "false", description = "Can send messages.")
    boolean can_send_messages;

    @Option(names = {"--audio"}, defaultValue = "false", description = "Can send audios.")
    boolean can_send_audios;

    @Option(names = {"--documents"}, defaultValue = "false", description = "Can send documents.")
    boolean can_send_documents;

    @Option(names = {"--photo"}, defaultValue = "false", description = "Can send photos.")
    boolean can_send_photos;

    @Option(names = {"--video"}, defaultValue = "false", description = "Can send video.")
    boolean can_send_videos;

    @Option(names = {"--video-note"}, defaultValue = "false", description = "Can send video note.")
    boolean can_send_video_notes;

    @Option(names = {"--voice-note"}, defaultValue = "false", description = "Can send voice note.")
    boolean can_send_voice_notes;

    @Option(names = {"--poll"}, defaultValue = "false", description = "Can send polls.")
    boolean can_send_polls;

    @Option(names = {"--other-messages"}, defaultValue = "false", description = "Can send other messages.")
    boolean can_send_other_messages;

    @Option(names = {"--web-preview"}, defaultValue = "false", description = "Can send web previews.")
    boolean can_add_web_page_previews;

    @Option(names = {"--change-info"}, defaultValue = "false", description = "Can change info.")
    boolean can_change_info;

    @Option(names = {"--invite"}, defaultValue = "false", description = "Can sinvite users.")
    boolean can_invite_users;

    @Option(names = {"--pin-message"}, defaultValue = "false", description = "Can pin message.")
    boolean can_pin_messages;

    @Option(names = {"--manage-topic"}, defaultValue = "false", description = "Can manage topic.")
